...
export const deletePatioAction: ActionFunctionAny<Action<any>> = createAction(
  DELETE_PATIO
);
export const deletePatioSuccessAction: ActionFunctionAny<
  Action<any>
> = createAction(DELETE_PATIO_SUCCESS);
export const deletePatioErrorAction: ActionFunctionAny<
  Action<any>
