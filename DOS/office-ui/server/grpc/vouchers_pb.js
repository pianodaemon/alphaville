...
goog.exportSymbol('proto.dylk.ItemsToReturn', null, global);
goog.exportSymbol('proto.dylk.PatioVoucher', null, global);
goog.exportSymbol('proto.dylk.SalidaEquipoData', null, global);
...
goog.exportSymbol('proto.dylk.VoucherIdList', null, global);
...
proto.dylk.Event = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dylk.Event.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.dylk.VoucherIdList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dylk.VoucherIdList.repeatedFields_, null);
};
goog.inherits(proto.dylk.VoucherIdList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dylk.VoucherIdList.displayName = 'proto.dylk.VoucherIdList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.dylk.ItemsToReturn = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dylk.ItemsToReturn.repeatedFields_, null);
};
goog.inherits(proto.dylk.ItemsToReturn, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dylk.ItemsToReturn.displayName = 'proto.dylk.ItemsToReturn';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.dylk.SalidaEquipoData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.dylk.SalidaEquipoData.repeatedFields_, null);
};
goog.inherits(proto.dylk.SalidaEquipoData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.dylk.SalidaEquipoData.displayName = 'proto.dylk.SalidaEquipoData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.dylk.Event.repeatedFields_ = [12];
 ...
 * @return {!Array<!proto.dylk.Item>}
 */
proto.dylk.Event.prototype.getItemlistList = function() {
  return /** @type{!Array<!proto.dylk.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dylk.Item, 12));
};
 ...
 * @return {!proto.dylk.Event} returns this
*/
proto.dylk.Event.prototype.setItemlistList = function(value) {
 ...
 * @return {!proto.dylk.Item}
 */
proto.dylk.Event.prototype.addItemlist = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 12, opt_value, proto.dylk.Item, opt_index);
};
 ...
 * @return {!proto.dylk.Event} returns this
 */
proto.dylk.Event.prototype.clearItemlistList = function() {
  return this.setItemlistList([]);
};
 ...
 * @const
 */
proto.dylk.VoucherIdList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.dylk.VoucherIdList.prototype.toObject = function(opt_includeInstance) {
  return proto.dylk.VoucherIdList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dylk.VoucherIdList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.VoucherIdList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dylk.VoucherIdList}
 */
proto.dylk.VoucherIdList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dylk.VoucherIdList;
  return proto.dylk.VoucherIdList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dylk.VoucherIdList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dylk.VoucherIdList}
 */
proto.dylk.VoucherIdList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dylk.VoucherIdList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dylk.VoucherIdList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dylk.VoucherIdList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.VoucherIdList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<number>}
 */
proto.dylk.VoucherIdList.prototype.getIdsList = function() {
 ...
 * @return {!proto.dylk.VoucherIdList} returns this
 */
proto.dylk.VoucherIdList.prototype.setIdsList = function(value) {
 ...
 * @return {!proto.dylk.VoucherIdList} returns this
 */
proto.dylk.VoucherIdList.prototype.addIds = function(value, opt_index) {
 ...
 * @return {!proto.dylk.VoucherIdList} returns this
 */
proto.dylk.VoucherIdList.prototype.clearIdsList = function() {
 ...
 * @const
 */
proto.dylk.ItemsToReturn.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.dylk.ItemsToReturn.prototype.toObject = function(opt_includeInstance) {
  return proto.dylk.ItemsToReturn.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dylk.ItemsToReturn} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.ItemsToReturn.toObject = function(includeInstance, msg) {
  var f, obj = {
    voucherid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    itemlistList: jspb.Message.toObjectList(msg.getItemlistList(),
    proto.dylk.Item.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dylk.ItemsToReturn}
 */
proto.dylk.ItemsToReturn.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dylk.ItemsToReturn;
  return proto.dylk.ItemsToReturn.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dylk.ItemsToReturn} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dylk.ItemsToReturn}
 */
proto.dylk.ItemsToReturn.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dylk.ItemsToReturn.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dylk.ItemsToReturn.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dylk.ItemsToReturn} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.ItemsToReturn.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getVoucherid();
  if (f !== 0) {
    writer.writeInt32(
...
/**
 * optional int32 voucherId = 1;
 * @return {number}
 */
proto.dylk.ItemsToReturn.prototype.getVoucherid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.dylk.ItemsToReturn} returns this
 */
proto.dylk.ItemsToReturn.prototype.setVoucherid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Array<!proto.dylk.Item>}
 */
proto.dylk.ItemsToReturn.prototype.getItemlistList = function() {
  return /** @type{!Array<!proto.dylk.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dylk.Item, 2));
};
 ...
 * @return {!proto.dylk.ItemsToReturn} returns this
*/
proto.dylk.ItemsToReturn.prototype.setItemlistList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.dylk.Item}
 */
proto.dylk.ItemsToReturn.prototype.addItemlist = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.dylk.Item, opt_index);
};
 ...
 * @return {!proto.dylk.ItemsToReturn} returns this
 */
proto.dylk.ItemsToReturn.prototype.clearItemlistList = function() {
  return this.setItemlistList([]);
};
 ...
 * @const
 */
proto.dylk.SalidaEquipoData.repeatedFields_ = [8];
 ...
 * @return {!Object}
 */
proto.dylk.SalidaEquipoData.prototype.toObject = function(opt_includeInstance) {
  return proto.dylk.SalidaEquipoData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dylk.SalidaEquipoData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.SalidaEquipoData.toObject = function(includeInstance, msg) {
  var f, obj = {
    platform: jspb.Message.getFieldWithDefault(msg, 1, ""),
    carriercode: jspb.Message.getFieldWithDefault(msg, 2, ""),
    patiocode: jspb.Message.getFieldWithDefault(msg, 3, ""),
    observations: jspb.Message.getFieldWithDefault(msg, 4, ""),
    unitcode: jspb.Message.getFieldWithDefault(msg, 5, ""),
    deliveredby: jspb.Message.getFieldWithDefault(msg, 6, ""),
    receivedby: jspb.Message.getFieldWithDefault(msg, 7, ""),
    itemstoreturnlistList: jspb.Message.toObjectList(msg.getItemstoreturnlistList(),
    proto.dylk.ItemsToReturn.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.dylk.SalidaEquipoData}
 */
proto.dylk.SalidaEquipoData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dylk.SalidaEquipoData;
  return proto.dylk.SalidaEquipoData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dylk.SalidaEquipoData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dylk.SalidaEquipoData}
 */
proto.dylk.SalidaEquipoData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new proto.dylk.ItemsToReturn;
      reader.readMessage(value,proto.dylk.ItemsToReturn.deserializeBinaryFromReader);
      msg.addItemstoreturnlist(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.dylk.SalidaEquipoData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dylk.SalidaEquipoData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dylk.SalidaEquipoData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dylk.SalidaEquipoData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPlatform();
  if (f.length > 0) {
    writer.writeString(
  ...
  f = message.getItemstoreturnlistList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      8,
      f,
      proto.dylk.ItemsToReturn.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getPlatform = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setPlatform = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string carrierCode = 2;
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getCarriercode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setCarriercode = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getPatiocode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setPatiocode = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getObservations = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setObservations = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional string unitCode = 5;
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getUnitcode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setUnitcode = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};


/**
 * optional string deliveredBy = 6;
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getDeliveredby = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setDeliveredby = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};


/**
 * optional string receivedBy = 7;
 * @return {string}
 */
proto.dylk.SalidaEquipoData.prototype.getReceivedby = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.setReceivedby = function(value) {
  return jspb.Message.setProto3StringField(this, 7, value);
};


/**
 * repeated ItemsToReturn itemsToReturnList = 8;
 * @return {!Array<!proto.dylk.ItemsToReturn>}
 */
proto.dylk.SalidaEquipoData.prototype.getItemstoreturnlistList = function() {
  return /** @type{!Array<!proto.dylk.ItemsToReturn>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.dylk.ItemsToReturn, 8));
};


/**
 * @param {!Array<!proto.dylk.ItemsToReturn>} value
 * @return {!proto.dylk.SalidaEquipoData} returns this
*/
proto.dylk.SalidaEquipoData.prototype.setItemstoreturnlistList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 8, value);
};


/**
 * @param {!proto.dylk.ItemsToReturn=} opt_value
 * @param {number=} opt_index
 * @return {!proto.dylk.ItemsToReturn}
 */
proto.dylk.SalidaEquipoData.prototype.addItemstoreturnlist = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 8, opt_value, proto.dylk.ItemsToReturn, opt_index);
};
 ...
 * @return {!proto.dylk.SalidaEquipoData} returns this
 */
proto.dylk.SalidaEquipoData.prototype.clearItemstoreturnlistList = function() {
  return this.setItemstoreturnlistList([]);
};
