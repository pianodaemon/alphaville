...
type Props = {
  createCarrierAction: Function;
  readCarrierAction: Function;
  updateCarrierAction: Function;
...
export const CarrierForm = (props: Props) => {
  const {
    createCarrierAction,
    readCarrierAction,
    updateCarrierAction,
  ...
  const onSubmit = (fields) => {
    ...
    */
    if (id) {
      delete fields.id;
      updateCarrierAction({ id, fields, history /* releaseForm */ });
    } else {
      createCarrierAction({ fields, history /* releaseForm */ });
    }
  };
  return (
