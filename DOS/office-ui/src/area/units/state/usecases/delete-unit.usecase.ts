...
export const deleteUnitAction: ActionFunctionAny<Action<any>> = createAction(
  DELETE_UNIT
);
export const deleteUnitSuccessAction: ActionFunctionAny<
  Action<any>
> = createAction(DELETE_UNIT_SUCCESS);
export const deleteUnitErrorAction: ActionFunctionAny<
  Action<any>
