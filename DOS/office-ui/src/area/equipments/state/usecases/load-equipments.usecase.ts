...
export const loadEquipmentsAction: ActionFunctionAny<Action<any>> = createAction(
  LOAD_EQUIPMENTS
);
export const loadEquipmentsSuccessAction: ActionFunctionAny<
  Action<any>
> = createAction(LOAD_EQUIPMENTS_SUCCESS);
export const loadEquipmentsErrorAction: ActionFunctionAny<
  Action<any>
