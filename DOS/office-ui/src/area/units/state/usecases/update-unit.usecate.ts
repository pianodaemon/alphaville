...
export const updateUnitAction: ActionFunctionAny<Action<any>> =
  createAction(UPDATE_UNIT);
export const updateUnitSuccessAction: ActionFunctionAny<Action<any>> =
  createAction(UPDATE_UNIT_SUCCESS);
export const updateUnitErrorAction: ActionFunctionAny<Action<any>> =
