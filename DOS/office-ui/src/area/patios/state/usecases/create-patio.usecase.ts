...
export const createPatioAction: ActionFunctionAny<Action<any>> =
  createAction(CREATE_PATIO);
export const createPatioSuccessAction: ActionFunctionAny<Action<any>> =
  createAction(CREATE_PATIO_SUCCESS);
export const createPatioErrorAction: ActionFunctionAny<Action<any>> =
