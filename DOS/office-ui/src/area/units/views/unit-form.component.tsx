...
type Props = {
  createUnitAction: Function;
  readUnitAction: Function;
  updateUnitAction: Function;
  unit: Unit | null;
};
...
export const UnitForm = (props: Props) => {
  ...
  const onSubmit = (fields) => {
    ...
    */
    if (id) {
      delete fields.id;
      updateUnitAction({ id, fields, history /* releaseForm */ });
    } else {
      createUnitAction({ fields, history /* releaseForm */ });
    }
  };
  return (
