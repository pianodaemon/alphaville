...
export const loadPatiosAction: ActionFunctionAny<Action<any>> = createAction(
  LOAD_PATIOS
);
export const loadPatiosSuccessAction: ActionFunctionAny<
  Action<any>
> = createAction(LOAD_PATIOS_SUCCESS);
export const loadPatiosErrorAction: ActionFunctionAny<
  Action<any>
