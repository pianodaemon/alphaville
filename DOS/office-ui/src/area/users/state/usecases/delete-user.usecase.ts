...
export const deleteUserAction: ActionFunctionAny<Action<any>> =
  createAction(DELETE_USER);
export const deleteUserSuccessAction: ActionFunctionAny<Action<any>> =
  createAction(DELETE_USER_SUCCESS);
export const deleteUserErrorAction: ActionFunctionAny<Action<any>> =
