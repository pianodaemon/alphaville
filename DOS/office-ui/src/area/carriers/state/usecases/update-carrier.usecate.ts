...
export const updateCarrierAction: ActionFunctionAny<Action<any>> =
  createAction(UPDATE_CARRIER);
export const updateCarrierSuccessAction: ActionFunctionAny<Action<any>> =
  createAction(UPDATE_CARRIER_SUCCESS);
export const updateCarrierErrorAction: ActionFunctionAny<Action<any>> =
